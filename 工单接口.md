...
获取工单:GET https://vpn.200461.xyz/api/v3/user/ticket/fetch
...
具体工单内容获取:GET https://vpn.200461.xyz/api/v3/user/ticket/fetch?id=7
...
回复消息:POST https://vpn.200461.xyz/api/v3/user/ticket/reply


创建工单:POST https://vpn.200461.xyz/api/v3/user/ticket/save
示例请求:subject=Test&level=0&message=Test%20information
请求时默认level=0

关闭工单:POST https://vpn.200461.xyz/api/v3/user/ticket/close
示例请求:id=7
