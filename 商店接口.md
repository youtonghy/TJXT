...
获取套餐:GET https://vpn.200461.xyz/api/v3/user/plan/fetch
...
购买:GET https://vpn.200461.xyz/api/v3/user/plan/fetch?id=1
...
验证优惠码:POST https://vpn.200461.xyz/api/v3/user/coupon/check
示例返回(无效):{
    "message": "\u4f18\u60e0\u5238\u65e0\u6548"
}

点击下单按钮后:
创建订单:POST https://vpn.200461.xyz/api/v3/user/order/save
示例请求(周期与ID):period=onetime_price&plan_id=1
示例返回(订单号):{"data":"2025090415093231566381577"}
然后刷新窗口内容为付款页面

付款页面:
请求内容(使用订单号):GET https://vpn.200461.xyz/api/v3/user/order/detail?trade_no=2025090415093231566381577
...
获取支付方式:GET https://vpn.200461.xyz/api/v3/user/order/getPaymentMethod
...
结账按钮:
请求:POST https://vpn.200461.xyz/api/v3/user/order/checkout
